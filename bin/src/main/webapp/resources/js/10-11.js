...
const v=new Vue({
	...
	methods : {
		주문하기: function(){	
			location.href="JavaquaServlet?command=cart_list&url=cart_order";						
		},
		수량업: function(cart_num){	
			
			const params = new URLSearchParams();
			params.append('command', 'cart_modify');
		...
		수량다운: function(cart_num,amount){	
				
			if(amount==1){alert("수량은 최소 1개입니다.");return;}
