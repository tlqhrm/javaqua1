        ...
        <div id="detail">
            <div id="bg1">
         		<div id="bg2" style="text-align:center; display:inline-block;">     
         			<span ><img id="main_img" src="/upload/${pvo.file1Arr[0] }" onerror="this.src='/images/이미지준비중.jpg'" style="margin-left:auto; margin-right:auto;"></span>
         			<div id="bg3" style=" float:left;">
         			<c:set var="size" value="${fn:length(pvo.file1Arr)}" />
         			<c:if test="${size > 3 }"><c:set var="size" value="5" /></c:if> 
					<c:forEach var="i" begin="0" end="${size - 1}">					
					    <span class="prev_img" style=""><img  src="/upload/${pvo.file1Arr[i] }" onerror="this.src='/images/이미지준비중.jpg'"> </span> 
                ...
                <c:forEach items="${pvo.category1Arr }" var="ca1">
                 	<c:if test="${ca1 eq 'new' }">
                 		<img src="images/상품아래/신상품.gif">
                 	</c:if>
                 	<c:if test="${ca1 eq 'sale' }">
                 		<img src="images/상품아래/세일.gif">
                 	</c:if>
                 	<c:if test="${ca1 eq 'best' }">
                 		<img src="images/상품아래/베스트.gif">
                 	</c:if>
                 </c:forEach>
                     <c:if test="${pvo.stock eq 0 }">
                 		<img src="images/상품아래/품절.jpg"><br>
                 	</c:if>
                    </div>                   
                    ${pvo.title }
                    <div id="tmain">
                        <table class="info">
                            ...
                            <tr>
                                ...
                                <span style="display:inline-block; height:27px; position:relative;">
                                    ...
                                    <a href="#none" onClick="changeCount('up')" id="up"><img src="/images/수량업.gif"></a>
                                    <a href="#none" onClick="changeCount('down')" id="down"><img src="/images/수량다운.gif"></a>
                                </span>    
								</td>
                            </tr>
                        </table>
                        <div id="tinfo">
                            (최소주문수량 1개 이상)<p id="tinfo"><img src="images/detail/느낌표.png" style="margin-top: 3px;">
            ...
            <section style="margin-top:50px;">
                	...
                	<div>
                    <img src="images/detail/이용매뉴얼.png">
                    </div>
                	<div style="float:left">${pvo.content }</div>

                    <!-- <img src="images/detail/상품결제정보.png"> -->
                    <img src="images/detail/배송정보.png">
                    <img src="images/detail/교환및반품정보.png">
